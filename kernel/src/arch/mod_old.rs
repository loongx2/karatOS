...
/// This is called before any other kernel initialization
...
/// Architecture-specific startup initialization
pub fn arch_startup_init(arch_config: &ArchConfig) {
    #[cfg(target_arch = "arm")]
    arm::startup_init(arch_config);
...
/// Early println function (before full UART driver is initialized)
pub fn early_println(msg: &str) {
    #[cfg(target_arch = "arm")]
    arm::early_println(msg);
...
/// Architecture-specific yield function
pub fn arch_yield() {
    #[cfg(target_arch = "arm")]
    arm::arch_yield();
...
/// Architecture-specific shutdown function
pub fn arch_shutdown() -> ! {
    #[cfg(target_arch = "arm")]
    arm::arch_shutdown();
